...
using Kingdee.CAPP.Controls.Properties;
...
namespace Kingdee.CAPP.Controls
{
    ...
    public class FlatTabControl : System.Windows.Forms.TabControl
    {
        ...
        public FlatTabControl()
        {
            ...
            Bitmap updownImage = Resources.TabIcons;
        ...
        internal void DrawControl(Graphics g)
        {
            ...
            Color color = Color.FromArgb(SystemColors.Control.A, SystemColors.Control.R, SystemColors.Control.G, SystemColors.Control.B);
            if (this.SelectedTab != null)
                color = this.SelectedTab.BackColor;
        ...
        internal void DrawTab(Graphics g, TabPage tabPage, int nIndex)
        {
            ...
            //----------------------------
            // draw border
            g.DrawRectangle(pen, recBounds);
            //g.DrawPolygon(SystemPens.ControlDark, pt);

            //----------------------------
            // clear bottom lines
            g.DrawLine(pen, recBounds.Right, recBounds.Top, recBounds.Right, recBounds.Bottom + 1);
            ...
            if (bSelected)
            {
                g.FillRectangle(new SolidBrush(Color.DarkGray), recBounds);
