...
namespace Kingdee.CAPP.Controls
{
    ...
    public partial class CustomScrollbar : UserControl
    {
        ...
        public CustomScrollbar()
        {
            ...
            moChannelColor = Color.FromArgb(232, 232, 236);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Brush oWhiteBrush = new SolidBrush(Color.FromArgb(232, 232, 236));
        ...
        void CustomScrollbar_MouseLeave(object sender, EventArgs e)
        {
            UpArrowImage = Resources.uparrow;
            DownArrowImage = Resources.downarrow;
            Invalidate();
        ...
        void CustomScrollbar_MouseHover(object sender, EventArgs e)
        {
            ...
            {
                UpArrowImage = Resources.uparrow_hover;
                DownArrowImage = Resources.downarrow;                
            }
            ...
            {
                UpArrowImage = Resources.uparrow;
                DownArrowImage = Resources.downarrow_hover;
            }
