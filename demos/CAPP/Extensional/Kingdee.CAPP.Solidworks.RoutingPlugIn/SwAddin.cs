...
{
    /// <summary>
    /// Summary description for Kingdee.CAPP.Solidworks.RoutingPlugIn.
    /// </summary>
    [Guid("2eff6d31-932a-4191-ad00-1d705e27a64f"), ComVisible(true)]
    [SwAddin(
        Description = "Kingdee.CAPP.Solidworks.RoutingPlugIn description",
        Title = "Kingdee.CAPP.Solidworks.RoutingPlugIn",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            int[] knownIDs = new int[1] { mainItemID1 };// new int[2] { mainItemID1, mainItemID2 };  
        ...
        #region UI Callbacks
        PartRelProcessLing prp = null;

        bool isShowProcessRouting = false;
        public void Routing()
        {
            //if (isShowProcessRouting) return;
            //ITaskpaneView pTaskPanView;
            //pTaskPanView = iSwApp.CreateTaskpaneView2("", "工艺路线");
            //frm = new ProcessLine((IModelDoc2)iSwApp.ActiveDoc,iSwApp);
            ...
            prp = new PartRelProcessLing(partName, modDoc, iSwApp);
            prp.ShowDialog();
            //isShowProcessRouting = true;
        ...
        public void WinFormInFeatureMgr()
        {
            ...
            ////frm = .Instance();
            //swFeatMgrTabTop = swModelViewMgr.CreateFeatureMgrWindowFromHandle(
            //    cmdGroup.SmallIconList, 
            //    (int)frm.Handle.ToInt64(), 
            //    "MyDotNetControl", 
        ...
        {
            //MessageBox.Show("OnDocLoad");
            return 0;
        }

        int FileOpenPostNotify(string FileName)
        {
            //MessageBox.Show("FileOpenPostNotify");
            AttachEventsToAllDocuments();
            return 0;
        }
