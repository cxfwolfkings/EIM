...
[assembly: ExtensionApplication(typeof(Kingdee.CAPP.Autocad.DrawRectanglePlugIn.MyPlugin))]
...
namespace Kingdee.CAPP.Autocad.DrawRectanglePlugIn
{
    ...
    public class MyPlugin : IExtensionApplication
    {
        ...
        void IExtensionApplication.Initialize()
        {
            ...
            DrawRectangleCommands drawRectangleCommand = new DrawRectangleCommands();
            drawRectangleCommand.DrawRectangleCommand();

            //drawRectangleCommand.ZoomRetangle();
